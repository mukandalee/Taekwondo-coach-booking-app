...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getBooleanExtra("ForAthlete",false)){
        ...
        gotToRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity.this, AthleteRegister.class));
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                if(FirebaseAuth.getInstance().getCurrentUser().isEmailVerified()){
                                    if(getIntent().getBooleanExtra("ForAthlete",false)){
                                        if(LoginActivity.this.getSharedPreferences("STORAGE",MODE_PRIVATE).edit().putString("USER_TYPE","ATHLETE").commit()){
                                            progressDialog.dismiss();
                                            startActivity(new Intent(LoginActivity.this, AthleteMainActivity.class));
                                            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
                                            finish();
                                        }else{
                                            progressDialog.dismiss();
                                            startActivity(new Intent(LoginActivity.this, AskCoachAthlete.class));
                                            overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
                                            finish();
                                        }

                                    }else{
                                        if(LoginActivity.this.getSharedPreferences("STORAGE",MODE_PRIVATE).edit().putString("USER_TYPE","COACH").commit()){
                                            progressDialog.dismiss();
    ...
    public void onBackPressed() {
        if(getIntent().getBooleanExtra("ForAthlete",false)){
            startActivity(new Intent(LoginActivity.this, AthleteLoginRegisterChoice.class));
            overridePendingTransition(android.R.anim.slide_in_left,android.R.anim.slide_out_right);
            finish();
        }else{
            startActivity(new Intent(LoginActivity.this, AskCoachAthlete.class));
