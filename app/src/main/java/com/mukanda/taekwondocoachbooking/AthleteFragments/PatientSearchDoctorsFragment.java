...
import com.mukanda.taekwondocoachbooking.Adapters.DoctorAdatper;
import com.mukanda.taekwondocoachbooking.DataRetrievalClass.Doctor;
...
public class PatientSearchDoctorsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressDialog.show();
        FirebaseDatabase.getInstance().getReference().child("CoachDetails").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        searchView.setQueryHint("Search Coach/Specialization");
