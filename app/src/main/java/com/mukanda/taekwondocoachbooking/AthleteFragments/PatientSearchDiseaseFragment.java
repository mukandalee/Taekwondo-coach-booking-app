...
import com.mukanda.taekwondocoachbooking.Adapters.DiseaseAdatper;
...
public class PatientSearchDiseaseFragment  extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressDialog.show();
        FirebaseDatabase.getInstance().getReference().child("SpecializationAndActivity").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        searchView.setQueryHint("Search Specialization");
    ...
    private void filter(String s){
        ...
        for(DiseaseAndSymptoms symptoms: diseaseAndSymptoms){
            if(symptoms.getSpecializationName().toLowerCase().contains(s.toLowerCase())){
