package com.mukanda.taekwondocoachbooking.CoachFragments;
...
import com.mukanda.taekwondocoachbooking.Adapters.AppointmentRequestAdapter;
...
public class AppointmentRequestFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressDialog.show();
        FirebaseDatabase.getInstance().getReference().child("PendingCoachAppointments").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        searchView.setQueryHint("Search Athletes");
