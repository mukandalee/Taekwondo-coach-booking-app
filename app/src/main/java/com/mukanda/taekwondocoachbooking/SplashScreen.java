...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("               Taekwondo Coach Booking");
        ...
        runnable=new Runnable() {
            ...
            public void run() {
                if(FirebaseAuth.getInstance().getCurrentUser()!=null && sharedPreferences.getString("USER_TYPE","NON").trim().equals("ATHLETE")){
                    SplashScreen.this.startActivity(new Intent(SplashScreen.this, AthleteMainActivity.class));
                    ...
                    SplashScreen.this.startActivity(new Intent(SplashScreen.this, CoachMainActivity.class));
                    SplashScreen.this.overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
                    SplashScreen.this.finish();
                }else{
                    SplashScreen.this.startActivity(new Intent(SplashScreen.this, AskCoachAthlete.class));
                    SplashScreen.this.overridePendingTransition(android.R.anim.fade_in,android.R.anim.fade_out);
                    SplashScreen.this.finish();
                }
            }
